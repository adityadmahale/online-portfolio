const projects = [
  ...
  },
  {
    ...
    description:
      "Implemented graphic equalizer on a hardware platform for the processing of real-time audio signals using digital signal processor TDA7315.Used AVR platform, peripheral interfacing hardware - Keypad and LCD and stereo power amplifier. Programmed using Embedded C.",
    skills: [],
  },
  {
    id: 4,
    ...
    description:
      "The project's goal was to provide accessibility to the digital world for people with motor disabilities.Built pupil tracking glasses mounted with compact IR sensitive camera and IR LED. Utilized digital video processing techniques to enhance a series of raw images received from the camera. MATLAB was used to design the software.",
    skills: [],
  },
];

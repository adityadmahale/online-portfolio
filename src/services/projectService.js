...
const projects = [
  {
    id: 1,
    title: "ServerlessBnB",
    link: "https://github.com/adityadmahale/ServerlessBnB",
    image: basePath + "/dal.png",
    description: [
      {
        id: 1,
        point:
    ...
    description: [
      {
        id: 1,
        point:
          "Built a data quality report, identified the existing data quality issues, and prepared a data quality plan",
      },
      {
        id: 2,
        point:
          "Preprocessed the data as per the data quality plan and found patterns in the clean data.",
      },
      {
        id: 3,
        point:
          "Built a Random Forest Classifier model and performed hyperparameter tuning to predict the churn",
      },
      {
        id: 4,
        point:
          "Developed a Neural Network Feedforward model and performed hyperparameter tuning for churn prediction",
      },
      {
        id: 5,
        point: "Compared the models using the Statistical Significance Test",
      },
    ],
    skills: ["Neural Networks", "Ensemble Machine Learning", "scikit-learn"],
  },
  {
    id: 3,
    title: "Dalhousie Multifaith Services",
    link: "https://github.com/adityadmahale/Dalhousie-Multifaith-Services",
    image: basePath + "/dal.png",
    description: [
      {
        id: 1,
        point:
          "The project brings comfortable counseling to students. Spreads awareness of mental health issues and encourages the practice of seeking help. It is a fully-featured website that brings together chaplains and students. It is a user-friendly, confidential, system, that builds a safe community. It includes appointment booking, events, timesheets, and spiritual wellness score modules.",
      },
    ],
    skills: [
      "Bootstrap",
  ...
  },
  {
    ...
    link: "https://github.com/adityadmahale/distributed-database",
    image: basePath + "/dal.png",
    description: [
      {
        id: 1,
        point:
          "The Distributed database management system operates in 2 Linux virtual instances in AWS and has an analytics engine to perform basic data analytics. Database handles requests from 2 users (one user for each VM instance). The database management system layer provides a command-line interface, and performs various functionalities of the database management system",
      },
    ],
    skills: ["Java", "Distributed Database System", "HA"],
  },
  {
    id: 5,
    title: "Multilingual Text to Audio Converter Website",
    link: "https://github.com/adityadmahale/multilingual-text-to-audio",
    image: basePath + "/dal.png",
    description: [
      {
        id: 1,
        point:
          "Developed a multilingual text to audio converter website using AWS Cloud services. The user can enter text value and convert it to audio in a language of their choice.",
      },
    ],
    skills: ["CloudFormation", "Lambda", "HA", "VPC", "EC2", "RDS", "ELB"],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    link: "https://adityacourse.blogspot.com/2019/11/ibm-data-science-capstone-project.html",
    description: [
      {
        id: 1,
        point:
